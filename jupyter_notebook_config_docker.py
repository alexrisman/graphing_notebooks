...
c.NotebookApp.keyfile = '/etc/ssl/notebook/jupyter.key'
c.NotebookApp.certfile = '/etc/ssl/notebook/jupyter.crt'
c.NotebookApp.token = u''
c.NotebookApp.tornado_settings = {'headers': {'Content-Security-Policy': "frame-ancestors *.armath.net *.squarespace.com self" }}